...
public class VentaDao extends AppCrud{
    ...
    final String TABLE_DETALLE_VENTA="DetalleVenta.txt";  
    ...
    public void registroVenta() {
        ...
        System.out.println("*******************Venta de Abarrotes***************");
        ...
        if (ventaTO!=null) {
            String opcion="SI";
            do {                
                DetalleVentaTO vdXTo=crearCarritoVenta(ventaTO);
    ...
    public DetalleVentaTO crearCarritoVenta(VentaTO vto) {
        util.clearConsole();
